    ...
    function animate() {
      ...
      for (let i = 0; i < particlesArray.length; i++) {
        ...
        for (let j = i; j < particlesArray.length; j++) {
          ...
          if (distance < 120) {
            ctx.beginPath();
            ctx.strokeStyle = `rgba(173, 170, 170, ${0.8 - distance/120})`;
            ctx.lineWidth = 0.8;
        ...
        <section className="hero-section" id="home">
          <div className="hero-content">
            ...
            <div className="hero-demo">
              <a href="#imageupload">
                <button className="primary-button">Let AI Solve the Equation</button>
              </a>
            </div>
          </div>
              <video className="demo-video" autoPlay loop muted>
                <source src="demo.mp4" type="video/mp4" className='video-container' />
